    ...
    >
      ...
      <CardContent sx={{ px: 2, py: 0, color: '#e7e7e7ff',height:'20%',    overflow: 'hidden',}}>
        <Typography variant="body2">
          <strong>Botspacehq</strong> WhatsApp now connects 3 billion users, a milestone reflecting its influence in messaging. Thanks to Meta’s investment in AI and business tools, WhatsApp not only enhances personal communication but also empowers businesses with robust AI features. Looking to ride this wave? BotSpace, a Meta Business Partner, helps your business shine on WhatsApp 🌍💬🚀
        </Typography>
      </CardContent>
